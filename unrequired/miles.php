<?php
    ...
    $sql = "SELECT at.*,up.f_name,up.l_name,up.u_id as user,up.avtar,pt.t_name,pt.id as task_id,pt.e_id as emp_id,at.id as main_id from accepted_task at,user_profile up,post_task pt where  up.u_id=at.c_id and at.t_id=pt.id and (at.statu=0 or at.statu=2) and at.adm_id='$USER_ID' and at.t_id='$token'";
    $note = '';
    $review_emp = 'none';
    $mark = '';
    switch ($TYPE)
    {
        case 2:
           $sql = "SELECT at.*,up.f_name,up.l_name,up.u_id as user,up.avtar,pt.t_name,pt.id as task_id,pt.e_id as emp_id,at.id as main_id from accepted_task at,user_profile up,post_task pt where up.u_id=at.adm_id and at.t_id = pt.id and at.c_id='$USER_ID' and at.emp_status is NULL and at.t_id='$token'";
            $note = 'none';
           break;
        case 3:
            $sql = "SELECT at.*,up.f_name,up.l_name,up.u_id as user,up.avtar,pt.t_name,pt.id as task_id,pt.e_id as emp_id,at.id as main_id from accepted_task at,user_profile up,post_task pt where up.u_id=at.adm_id and at.t_id = pt.id and at.c_id='$USER_ID' and at.emp_status is NULL and at.t_id='$token'";
			...
			<div class="row">
				...
				<div class="col-xl-12" >
                        <div class="dashboard-box margin-top-0">
                            <div class="dashboard-box-header" style="margin:20px;display:flex;flex:1;justify-content:flex-end;display:<?=$note?>">
                                ...
                                <div class="col-lg-5 col-md-5">
                                    ...
                                    <?php
                                        ...
                                        switch($TYPE)
                                        {
                                            ...
                                            case 3:
                                                ?>
                                                    <a href=".<?=$m['task_id']?>8449" id="mark<?=$m['task_id']?>" style="display:" class="popup-with-zoom-anim button gray ripple-effect margin-top-5 margin-bottom-10">Mark Completed</a>
                                                <?php
                                                break;
                                        }
