...
-- Host: 127.0.0.1
<<<<<<< HEAD
-- Generation Time: May 01, 2021 at 07:18 PM
=======
-- Generation Time: May 04, 2021 at 03:31 PM
>>>>>>> f3f41c3344b8f807ead61e1c181085c69cc9852a
...
<<<<<<< HEAD
-- Error reading data for table skoolyard.accepted_task: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `skoolyard`.`accepted_task`' at line 1
=======
...
(6, 8, 4, 1, 'Savage work and now I am in love with the working style of this work ', 0, 1, 1, 0, '2021-04-13 17:59:14', 5, 2, NULL, 16, NULL),
(14, 6, 4, 8, 'Good', 1, 1, 1, 1, '2021-04-13 17:58:12', 5, 1, 100, 16, NULL),
(15, 45, 11, 9, '', 0, 0, 0, 0, '2021-05-01 06:51:53', NULL, 2, 6, 0, NULL),
(16, 45, 12, 10, '', 0, 0, 0, 0, '2021-05-01 07:13:56', NULL, 0, 400, 0, NULL),
(17, 45, 14, 11, '', 0, 0, 0, 0, '2021-05-03 04:59:40', NULL, 0, 5, 0, NULL);
>>>>>>> f3f41c3344b8f807ead61e1c181085c69cc9852a
...
(26, 44, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-01 06:43:26', 5),
(27, 45, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-01 06:47:50', 3);
...
(2, 4, 2, 2000, 2, 2, 'test', '2021-04-14 11:53:25', 0),
(6, 8, 8, 54, 4, 2, 'test description', '2021-04-14 11:53:15', 0),
...
(9, 11, 45, 6, 10, 2, 'ok I will make it.', '2021-05-01 06:51:26', 1),
(10, 12, 45, 400, 4, 1, 'I have advance technologies tool', '2021-05-01 07:13:56', 1),
(11, 14, 45, 5, 6, 2, 'Good skills', '2021-05-03 04:59:41', 1);
...
=======
(1, 4, 8, 6, 'Create a mockup!!!', 'Happy Diwali', '2021-05-01 07:49:22', '2021-04-30', 0, 1, 300, NULL),
(2, 4, 8, 6, 'Create UI designs', 'Show the UI design of the website as mentioned in the project details', '2021-04-06 09:16:34', '2021-05-14', 0, 1, 200, NULL),
(3, 4, 8, 6, 'Back-end Connection ', 'Connect the front-end of the website with the back-end', '2021-04-06 10:34:06', '2021-05-30', 1, 2, 500, NULL),
(4, 14, 44, 45, 'First Payment', 'initial payment', '2021-05-03 05:02:04', '2021-05-05', NULL, NULL, 5, NULL);
...
(19, 16, 'hahahah', 'high', '2021-04-12 17:24:01'),
(20, 16, 'hihihihi', 'low', '2021-04-12 17:24:39');
...
(4, 16, 'Bugs freeee', '2', '2021-04-09', 'Pakistan', 1, 100, 'You must be perfect in all fields and a well educated person', 1, 4, '2021-05-01 07:11:35', 1),
...
(11, 44, 'Website work', '4', '2021-05-10', 'Delhi', 100, 500, 'Need to be a good project', 1, 1, '2021-05-01 06:46:18', 1),
(12, 44, 'Web Chatbot', '4', '2021-05-05', 'Noida', 50, 250, 'Need a web application where need to install chatbot', 1, 1, '2021-05-01 07:12:13', 1),
(13, 44, 'Keyboard', '5', '2021-05-07', 'USA', 500, 1000, 'Need to remove tree from ground', 1, 1, '2021-05-01 07:08:23', 2),
(14, 44, 'Pen Work', '2', '2021-05-20', 'Manali', 100, 1000, 'Need to remove snow', 1, 1, '2021-05-03 04:58:08', 1);
...
(44, 'shiv@gmail.com', '25d55ad283aa400af464c76d713c07ad', 5),
(45, 'shiv1@gmail.com', '25d55ad283aa400af464c76d713c07ad', 3);
...
CREATE TABLE `user_profile` (
  ...
  `intro` text NOT NULL,
  `user_wallet` float NOT NULL DEFAULT 0,
  `status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `user_profile` (`id`, `u_id`, `f_name`, `l_name`, `avtar`, `mobile`, `address`, `hourly_rate`, `tagline`, `nationality`, `intro`, `user_wallet`, `status`) VALUES
(1, 2, 'Ocean', 'Negi', 'uploads/1615971240_bajrangbali.jpg', '1234567890', 'harrawala', -200, '', 'UK', 'test intro', 0, 2),
(3, 8, 'Pancham', 'Sheoran', 'uploads/1616598770_IMG-20190824-WA0010-01-01.jpeg', '8126828531', 'neww', 21, 'I am a developer', 'US', 'Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment.\r\n\r\nCapitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway will close the loop on focusing solely on the bottom line.', 0, 1),
(5, 6, 'Rahul', 'Chand', 'uploads/1615966394_1614140611914-01.jpeg', '8109716921', 'Dehradun', 84, 'nothing', 'US', 'Best of best', 0, 2),
(9, 15, 'Akshat', 'Tripathi', 'uploads/1615971240_bajrangbali.jpg', '8109716921', 'ghr p', 134, 'lucky', 'IN', 'test', 0, 0),
(10, 16, 'Vansh', 'Patpatia', 'uploads/111.jpeg', '8449089069', 'Hawa Mahal lane no. 5 Dhaka, Bangladesh', 50, 'Cyber Flow : The flow of code!!', 'US', 'I am a student who is at present developing his skills just to make a better career!', 0, 5),
(11, 17, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(12, 18, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(13, 19, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(14, 20, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 2),
(15, 21, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(16, 22, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(17, 23, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(18, 24, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(19, 25, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(20, 26, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(21, 27, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(22, 28, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(23, 29, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(24, 31, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(25, 33, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(26, 34, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(27, 35, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(28, 36, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(29, 37, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(30, 42, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(31, 43, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 0, 0),
(32, 44, 'Shiv', 'Kumar', 'images/user-avatar-placeholder.png', '9999999999', 'Noida', 0, 'I am best', 'IN', 'this is my introduction', 0, 0),
(33, 45, '', '', 'images/user-avatar-placeholder.png', '', '', 0, '', '', '', 125, 0);
...
--
-- Indexes for table `milestones_payment`
--
ALTER TABLE `milestones_payment`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `milestones_transaction`
--
ALTER TABLE `milestones_transaction`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `milestones_payment`
--
ALTER TABLE `milestones_payment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `milestones_transaction`
--
ALTER TABLE `milestones_transaction`
