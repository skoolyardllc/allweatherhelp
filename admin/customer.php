<?php
	...
	$sql = "select u.email,u.id,u.stat  , up.f_name,up.l_name from users u,user_profile up  where  u.id=up.u_id and u.type=5 order by u.id desc";
...

    {
...

        {
            ...
            case 1:
				...
				$sql = "select u.email,u.id,u.stat  , up.f_name,up.l_name from users u,user_profile up  where  u.id=up.u_id and u.type=5 and u.stat=1 order by u.id desc";
            ...
            case 2:
                ...
                $sql = "select u.email ,u.id ,u.stat, up.f_name,up.l_name from users u,user_profile up  where  u.id=up.u_id and u.type=5 and u.stat=2 order by u.id desc";
			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
						...
						<div class="breadcrumb-title pr-3">Customers</div>
					...
					<div class="user-profile-page">
																...
																?>
																	...
																	<tr>
																		...
																		<td>
																			...
																			<a href="profile?token=<?=$p['id']?>" class="btn btn-outline-primary" style="border:0"  type="button" ><i class="bi bi-eye"></i>View</a>
						...
						<?php
							...
							{  
								...
								{
									$t = $_GET['token'];
									$href = "customer?token=$t&page=$page";	
								}
								else
								{
