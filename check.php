                                    ...
                                    <div class="user-status">
                                        ...
                                        <div class="user-details">
                                            <div class="user-avatar status-online"><img
                                                    src="images/user-avatar-small-01.jpg" alt=""></div>
                                            <div class="user-name">
                                                Pancham Sheoran <span>CONTRACTOR</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="status-switch" id="snackbar-user-status">
                                            <label class="user-online current-status"
                                                onclick="status_online(1)">Online</label>
                                            <label class="user-invisible "
                ...
                <div class="sidebar-container">
                    ...
                    <div class="sidebar-widget">
                        ...
                        <input class="range-slider" type="text" value="" data-slider-currency="$" data-slider-min="10"
                            data-slider-max="2500" data-slider-step="25" data-slider-value="[10,2500]" />
                    </div>
                    ...
                    <a href="single-task-page.html" class="task-listing">
                        ...
                        <div class="task-listing-details">
                            ...
                            <div class="task-listing-description">
                                ...
                                <p class="task-listing-text">Bring to the table win-win strategies to ensure domination
                                    and user generated content in real-time will have multiple touchpoints.</p>
                                <div class="task-tags">
                    ...
                    <a href="single-task-page.html" class="task-listing">
                        ...
                        <div class="task-listing-details">
                            ...
                            <div class="task-listing-description">
                                ...
                                <p class="task-listing-text">Capitalize on low hanging fruit to identify a ballpark
                                    value added activity to beta test. Override the digital divide with additional.</p>
                                <div class="task-tags">
                                    <span>Python</span>
                                    <span>Flask</span>
                    ...
                    <a href="single-task-page.html" class="task-listing">
                        ...
                        <div class="task-listing-details">
                            ...
                            <div class="task-listing-description">
                                ...
                                <p class="task-listing-text">Completely synergize resource taxing relationships via
                                    premier niche markets. Professionally cultivate customer service with robust ideas.
                                </p>
                                <div class="task-tags">
                                    <span>WordPress</span>
                    ...
                    <a href="single-task-page.html" class="task-listing">
                        ...
                        <div class="task-listing-details">
                            ...
                            <div class="task-listing-description">
                                ...
                                <p class="task-listing-text">Objectively innovate empowered manufactured products
                                    whereas parallel platforms. Extensible testing procedures for reliable supply.</p>
                                <div class="task-tags">
                                    <span>PHP</span>
    ...
    <div id="footer">
        ...
        <div class="footer-bottom-section">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        © 2019 <strong>AWH</strong>. All Rights Reserved.
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from www.vasterad.com/themes/AWH/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Feb 2021 18:37:06 GMT -->
