	...
	<div class="dashboard-content-inner" >
		...
		<div class="dashboard-headline">
 		...
 		<div class="container">
 			...
 			<div class="row" id="transactionsonphone">
			 <div class="section-headline border-top margin-top-45 padding-top-45 margin-bottom-30">
 					<h4>Transaction Details</h4>
 				</div>
 			<div class="col-lg-8 col-md-8 border-right" style="overflow-y: scroll;height:130vh">
					...
					<div class="dashboard-box margin-top-0" id="transactiondetails" style="display:none;">
						...
						<div class="content with-padding padding-bottom-0">
							...
							<div class="row" >
									...
									<a href='#' id="viewMilestone" style="margin-bottom:20px"><i class='fas fa-eye'></i> View Milestone</a>
							</div>
...
{
	$.get('milestone_show_transaction.php?user_id=<?= $USER_ID ?>&page='+page, function(response) {
			console.log(response);		
			$('#panelfordetails').html(response.data);
			$("#pagesbutton").html(response.pages)
			$("#loader").remove();
...
function viewonlaptop(payment_ref,user,description,time,amount,status,id,project_id)
{
	...
	$("#amount").val("$"+amount);
	$("#status").val(status)
	$("#viewMilestone").attr('href',"milestone?token="+project_id)
